...
contract("OB Rewards Contract", function() {
    ...
    var createPendingTransactions = async(start, numberOfTransactions)=>{
    ...
    before(async() => {
        ...
        this.rewards = await OBRewards.new(promotedSellers, 550000000000000000000, 432000, this.escrow.address, this.OBT.address, endDate, {from:acct[0]});
        
        await this.OBT.transfer(this.rewards.address, 2200000000000000000000, {from:acct[0]});
