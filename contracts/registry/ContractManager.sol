...
contract ContractManager is Ownable {
    ...
    */
    ...
    /**
    * @dev Mapping of contract name and each of its different versions
    */
    mapping(string=>mapping(string=>Version)) internal  contractVsVersions;

    /**
    * @dev Mapping between contract name and its recommended version
    */
    ...
    /**
    * @dev Allow owner to add new version for a contract
    ...
    */
      ...
      nonZeroAddress(_implementation)
    {
      ...
      require(
        AddressUtils.isContract(_implementation),
    ...
    /**
    * @dev change status of a version
    ...
    * @param versionName Version of the contract
    */
    function markVersionAudited(string contractName, string versionName)
      external
      onlyOwner
      contractRegistered(contractName)
      versionExists(contractName, versionName)
    ...
    */
    function markRecommendedVersion(string contractName, string versionName)
      external
      onlyOwner
      contractRegistered(contractName)
      versionExists(contractName, versionName)
    ...
    */
    function getRecommendedVersion(string contractName)
      external
      view
      contractRegistered(contractName)
      returns (
